...
class Installer:
    ...
    def Setup_Warehouse(self):
        ...
        try:
            ...
            autostart_workstation_app.write("@lxterminal -e bash /home/pi/ServerFiles/StorageManagement/GUI/StorageWorkerLauncher.sh")
            ...
            os.system("echo \"[Desktop Entry]\n"
                      ...
                      "Icon=/home/pi/ServerFiles/StorageManagement/Logos/desktoplogo.png\n\" > /home/pi/Desktop/StorageWorker.desktop")
    ...
    def Setup_Workstation(self):
        ...
        try:
            ...
            autostart_workstation_app = open("/etc/xdg/lxsession/LXDE-pi/autostart", "a")
            autostart_workstation_app.write("@lxterminal -e bash /home/pi/ServerFiles/Workflow/Workstation/WorkstationLauncher.sh")
            autostart_workstation_app.close()
            ...
            os.system("echo \"[Desktop Entry]\n"
                      ...
                      "Icon=/home/pi/ServerFiles/Workflow/Workstation/Logos/desktoplogo.png\n\" > /home/pi/Desktop/WorkstationApp.desktop")
            ...
            os.system("echo \"[Desktop Entry]\n"
                      ...
                      "Icon=/home/pi/ServerFiles/Workflow/WorkflowPlanner/Logos/desktoplogo.png\n\" > /home/pi/Desktop/WorkflowPlannerApp.desktop")
